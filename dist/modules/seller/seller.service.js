...
const manageMedicineDB = async (name, price, stock, description, sellerId, manufacturer, category) => {
...
const updateMedicineDB = async (medicineId, sellerId, updateData) => {
...
const deleteMedicineDB = async (medicineId, sellerId) => {
...
const getSellerOrdersDB = async ({ sellerId }) => {
...
const dashboardDB = async ({ sellerId }) => {
